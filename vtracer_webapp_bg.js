...
export class BinaryImageConverter {
    ...
    */
    init() {
        wasm.binaryimageconverter_init(this.ptr);
    }
    /**
    * @returns {boolean}
    */
    tick() {
        const ret = wasm.binaryimageconverter_tick(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {number}
    */
    progress() {
        const ret = wasm.binaryimageconverter_progress(this.ptr);
        return ret >>> 0;
    }
}
/**
...
export class ColorImageConverter {
    ...
    */
    init() {
        wasm.colorimageconverter_init(this.ptr);
    }
    /**
    * @returns {boolean}
    */
    tick() {
        const ret = wasm.colorimageconverter_tick(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {number}
    */
    progress() {
        const ret = wasm.colorimageconverter_progress(this.ptr);
        return ret;
    }
}
...
export function __wbg_createElementNS_1561aca8ee3693c0() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
...
export function __wbg_prepend_c8ab86479ede1834() { return handleError(function (arg0, arg1) {
...
export function __wbg_getImageData_1d31a94ff8a4a1d7() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
...
export function __wbg_data_f13601b88960b7eb(arg0, arg1) {
